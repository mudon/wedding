...
export const Gate = ({ onGateOpen }: Props) => {
  ...
  return (
    <div className={`flex w-[28rem] min-h-screen`} style={{
      backgroundImage: `url(${background})`,
      backgroundSize: "100% 100%",
      backgroundPosition: "center",
    }}>
      <div className='relative w-1/2 h-full bg-transparent flex justify-end items-center'
      style={{
        zIndex: 7,
      ...
      <div className="absolute w-full h-full left-0 backdrop-blur-sm" style={{
        zIndex: 6,
        transformOrigin: "left",
        transition: "all 1s",
        transform: isOpen ? "rotateY(150deg)" : "",
        ...
        <div className="flex justify-center items-center flex-col h-full w-full">
          <div className="relative bottom-7 flex justify-center items-center flex-col gap-3 h-full w-[270px]">
            ...
            >
              ...
              <p className="default-font text-md">03 FEBRUARI 2025</p>
            </div>
            <button className='bg-black text-white p-4 rounded-lg relative z-10'
              style={{
                transformOrigin: "left",
                transition: "all 1s",
