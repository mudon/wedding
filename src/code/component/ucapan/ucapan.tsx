  ...
  return (
    <>
      <button
        ...
        className="mt-5 flex justify-center items-center border-[2px] border-gray-900 p-3 rounded-full gap-2"
      >
        <span>
          <FaPenNib />
        </span>
      ...
      {openWindow && (
        ...
        >
          <div
            className="h-[29rem] w-[21rem] relative bottom-[30rem] text-black bg-white rounded-lg z-3"
            style={{ zIndex: 2 }}
            ref={windowRef}
          >
            <form
