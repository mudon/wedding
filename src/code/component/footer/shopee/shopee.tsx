...
export const ShopeeGiftLink = () => {
  const senaraiBarang = [
    {
      ...
      linkBarang: "https://shopee.com.my/product/275298889/14100201304?gads_t_sig=VTJGc2RHVmtYMTlxTFVSVVRrdENkVHQ3ZkZSUTMrR3pBWmZZNzdrcnRBMFlyTE9RS0wzMlYyS01TMmFLMDA2WXo2S0JSMmc5amhJekZEUXZsQXJvT0t5alpVM000OWJMOXhhOUk2OVlCS05QbGhETlZ2RGFHNnEwdFNURVhVL1RkSWdmL1ZhSTRPL29sUkJudHROaUNBPT0&gad_source=1&gclid=Cj0KCQiAyoi8BhDvARIsAO_CDsB301N-ybYeBJBdoVmRfV3xJZdMKKpE0067_QcFeQ19LOrt8PRTudIaAid-EALw_wcB", // Example link
  ...
  return (
    ...
    >
        <div>
            <div className="default-font text-black text-xl my-[10px]">Wishlist</div>
            <div className={isTempah? "hidden" : ""}>
              <div className="h-2/4 mx-5 mb-5">
                <div className="default-font text-black">
                  ...
                  <div className="bg-gray-100 text-center py-1 px-5 rounded-lg">Lot 1007 Kampung Pengkalan Batu, 17000, Pasir Mas, Kelantan</div>
                </div>
                <div className="default-font text-black">
                  <p className="text-lg">Nombor Telefon</p>
                  <span className="bg-gray-100 text-center py-1 px-5 rounded-lg">0145197269</span>
                </div>
              </div>
                <div
      ...
      {isTempah && (
        ...
        animate={{ opacity: 1, y: 0 }}
      >
        <form onSubmit={handleSubmit(tempah)} className="w-full bg-white rounded-md text-black flex flex-col gap-2 p-3">
         <div className="flex gap-x-3 items-center">
          ...
          <a
            ...
            href={
              clickedItemId !== null
                ? senaraiBarang.find((barang) => barang.id === clickedItemId)
                    ?.linkBarang
                : "#"
            }
            target="_blank"
