...
function Content() {
  ...
  return (
    <>
      <section
        className="w-[28rem] flex justify-center items-center pt-[2rem]"
        style={{
        ...
        <div className="w-[240px] flex justify-center items-center flex-col gap-y-7 ">
          <div className="flex justify-center items-center flex-col gap-y-5 scroll-animation invisible-animation">
            ...
            <div className="flex justify-center items-center flex-col scroll-animation invisible-animation">
              <p className="text-center font-medium text-2xl custom-font-cinzel">
                Hishamuddin
              </p>
              <p className="text-lg default-font">
                (Bapa Pengantin Lelaki(Allahyarham))
              </p>
      ...
      <section
        className="w-[28rem] flex flex-col items-center pt-7"
        style={{
          backgroundImage: `url(${
            backgroundImageVisible ? backgroundLow : ""
          })`,
          backgroundSize: "100%",
          backgroundPosition: "center",
        }}
      >
        <div className="w-[240px] flex justify-center items-center flex-col gap-y-7">
          <div className="flex justify-center items-center flex-col scroll-animation invisible-animation">
            ...
            <p className="text-xl font-medium custom-font-cinzel">
              10 May 2025
            </p>
            <p className="text-[15px] custom-font-cinzel mb-7">
              12 Zulkaedah 1446H
            </p>
            <div className="w-[13rem] scroll-animation invisible-animation">
              <img src={wedLine} />
      ...
      <section
        className="w-[28rem] flex flex-col items-center pt-7 gap-5"
        style={{
          backgroundImage: `url(${
            backgroundImageVisible ? backgroundLow : ""
          })`,
      ...
      <section
        className="w-[28rem] h-[39rem] flex flex-col items-center pt-7 gap-5"
        style={{
          backgroundImage: `url(${
            backgroundImageVisible ? backgroundLow : ""
          })`,
        ...
        <div className="w-[240px] flex justify-center items-center flex-col">
          <div className="border border-black rounded-md p-5 text-lg font-base custom-font-cormorant-garamond scroll-animation invisible-animation">
            <div>
              ...
              rahmat kepada kedua mempelai ini,
            </div>
            <div>Kurniakanlah mereka zuriat yang soleh dan solehah.</div>
            <div>
